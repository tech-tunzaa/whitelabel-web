...
export function VendorDetails({ vendor, onApprove, onReject, isMobile = false }) {
        ...
        <TabsContent value="approval" className="space-y-6 pt-4">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <Checkbox id="kyc-verified" checked={kycVerified} onCheckedChange={setKycVerified} />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-end">
            ...
            <Button
              onClick={() => onApprove(vendor.id, commissionPlan, kycVerified)}
