...
export default function AddVendorPage() {
  ...
  function onSubmit(data: VendorFormValues) {
    ...
    // 1. Upload the documents to your storage
    // 2. Create the vendor in your database
    // 3. Redirect to the vendor list or the new vendor's details page

    toast("Vendor application submitted", {
      description:
        "The vendor has been added to the pending applications list.",
    });

    console.log("Form data:", data);
    console.log("Identity documents:", identityDocs);
    console.log("Business documents:", businessDocs);
    console.log("Bank documents:", bankDocs);
